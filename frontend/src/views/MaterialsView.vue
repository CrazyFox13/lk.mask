  ...
  <v-row class="mx-3 mt-5">
    <v-col cols="12">
      <div class="d-flex align-items-center">
        <div class="text-h6">Материлы</div>
        <v-spacer/>
        <v-btn small to="/materials/create" color="primary">Добавить страницу</v-btn>
      </div>
    </v-col>
    <v-col cols="12">
      <v-data-table
...
export default {
  ...
  data() {
    return {
      ...
      resourceApiParams:"type=material",
      deleteSwalTitle: "Вы действительно хотите удалить страницу?"
    }
  },
  methods: {
    move(dir, item) {
