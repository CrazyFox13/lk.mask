...
<head>
    ...
    <title>Приглашение в приложение ASTT</title>
...
<table id="allrecords" class="t-records" data-tilda-email="yes" data-tilda-project-id="6660033"
       data-tilda-page-id="33309501" data-tilda-page-alias="" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td style="background-color: #efefef; "><!--record_mail-->
            ...
            <table id="rec538398467" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="323">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin538398467" class="r"
            ...
            <table id="rec538398468" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="329">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin538398468" class="r"
                               style="margin: 0 auto;background-color:#ffffff;border-spacing: 0;width:600px;"
                               align="center">
                            <tr>
                                        ...
                                        <tr>
                                            <td style="text-align: center; padding: 0 0 0;">
                                                <div
                                                    ...
                                                    <br/>Приглашаю вас в ASTT.SU присоединиться к организации
                                                    {{$company->title}}. Вы сможете создавать заявки на спецтехнику,
                                                    получите доступ к поставщиками, заказчикам и многому
                                                    другому.<br/><br/>Пожалуйста, нажмите на кнопку, чтобы подтвердить
                                                    адрес электронной почты и создать пароль.
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
            ...
            <table id="rec538398469" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="618">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin538398469" class="r"
                               style="margin: 0 auto;background-color:#ffffff;border-spacing: 0;width:600px;"
                               align="center">
                            <tr>
                                <td style="padding-bottom:0px;padding-left:30px;padding-right:30px;">
                                                    ...
                                                    <tr>
                                                        <td> <!--[if mso]>
                                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                ...
                                                                href="{{$url}}"> Принять приглашение </a> <!--[endif]-->
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
            ...
            <table id="rec538469829" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="617">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin538469829" class="r"
                               style="margin: 0 auto;background-color:#ffffff;border-spacing: 0;width:600px;"
                               align="center">
                            <tr>
                                <td style="padding-top:15px;padding-bottom:30px;padding-left:30px;padding-right:30px;">
                                    <table valign="top" border="0" cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tr>
                                            <td style="text-align: center; padding: 0 0 0;">
                                                <div
                                                    style="margin: 0 auto; font-weight: normal; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; color:#8c8c8c;font-size:14px;line-height:1.4;max-width:350px;">
                                                    Либо перейдите по <a href="{{$url}}">ссылке</a></div>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
