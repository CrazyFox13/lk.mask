...
<head>
    ...
    <title>У вас новая претензия</title>
...
<table id="allrecords" class="t-records" data-tilda-email="yes" data-tilda-project-id="6660033"
       data-tilda-page-id="33306821" data-tilda-page-alias="" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td style="background-color: #efefef; "><!--record_mail-->
            ...
            <table id="rec538353768" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="323">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin538353768" class="r"
            ...
            <table id="rec538353770" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="329">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin538353770" class="r"
                               style="margin: 0 auto;background-color:#ffffff;border-spacing: 0;width:600px;"
                               align="center">
                            <tr>
                                        ...
                                        <tr>
                                            <td style="text-align: center; padding: 0 0 0;">
                                                <div
                                                    ...
                                                    Вам поступила новая претензия №{{$report->id}} от {{$author}}
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
            ...
            <table id="rec538353771" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="618">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin538353771" class="r"
                               style="margin: 0 auto;background-color:#ffffff;border-spacing: 0;width:600px;"
                               align="center">
                            <tr>
                                                    ...
                                                    <tr>
                                                        <td> <!--[if mso]>
                                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                ...
                                                                href="{{url('profile/reports')}}"> Перейти на сайт </a>
                                                            <!--[endif]--> </td>
                                                    </tr>
                                                </table>
                                            </td>
