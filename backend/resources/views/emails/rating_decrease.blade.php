...
<table id="allrecords" class="t-records" data-tilda-email="yes" data-tilda-project-id="6660033"
       data-tilda-page-id="33701665" data-tilda-page-alias="" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td style="background-color: #efefef; "><!--record_mail-->
            ...
            <table id="rec544656825" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="324">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin544656825" class="r"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style=""><a href="{{url("/")}}"> <img width="600"
                                                                                      ...
                                                                                      src="{{url("/images/astt-rating-down.png")}}">
                                                </a></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: center; padding: 24px 30px 0;"><a href="{{url("/")}}"
                                                    ...
                                                    <div
                                                        ...
                                                        <strong>Ваш рейтинг упал до {{$company->rating}}</strong></div>
                                                </a></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: center; padding: 11px 30px 0;">
                                                <div
                                                    ...
                                                    Но еще не поздно все исправить. Получайте положительные отзывы от
                                                    заказчиков, и рейтинг поднимется.
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
