                                        ...
                                        <tr>
                                            <td style="text-align: center; padding: 0 0 0;">
                                                <div
                                                    ...
                                                    Здравствуйте, {{$user->getRawOriginal('name')}}!
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td style="text-align: center; padding: 0 0 0;">
                                                <div
                                                    ...
                                                    <br/>Мы получили запрос о восстановлении пароля от Вашего личного
                                                    кабинета на портале ASTT.SU. Пожалуйста, нажмите на кнопку, чтобы
                                                    восстановить пароль.
                                                </div>
                                            </td>
                                        </tr>
                                                    ...
                                                    <tr>
                                                        <td> <!--[if mso]>
                                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                ...
                                                                href="{{$resetLink}}"> Восстановить пароль </a>
                                                            <!--[endif]-->
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <tr>
                                            <td style="text-align: center; padding: 0 0 0;">
                                                <div
                                                    ...
                                                    Либо перейдите по <a href="{{$resetLink}}">ссылке</a></div>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
