...
<head>
    ...
    <title>Предложение по заявке отклонено</title>
                                        ...
                                        <tr>
                                            <td style="text-align: center; padding: 24px 30px 0;"><a href="{{url("/")}}"
                                                    ...
                                                    <div
                                                        ...
                                                        <strong>Предложение по заявке отклонено</strong></div>
                                                </a></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: center; padding: 11px 30px 0;">
                                                <div
                                                    ...
                                                    Ваше предложение по заявке "{{$order->title}}" было отклонено
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                                    ...
                                                    <tr>
                                                        <td> <!--[if mso]>
                                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                ...
                                                                href="{{url("/orders/{$order->id}")}}">Открыть заявку</a> <!--[endif]-->
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
