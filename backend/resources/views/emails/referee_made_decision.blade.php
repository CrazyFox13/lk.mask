...
<head>
    ...
    <title>Арбитр принял решение</title>
...
<table id="allrecords" class="t-records" data-tilda-email="yes" data-tilda-project-id="6660033"
       data-tilda-page-id="34027402" data-tilda-page-alias="" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td style="background-color: #efefef; "><!--record_mail-->
            ...
            <table id="rec549848305" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="323">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin549848305" class="r"
            ...
            <table id="rec549848306" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="329">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin549848306" class="r"
                               style="margin: 0 auto;background-color:#ffffff;border-spacing: 0;width:600px;"
                               align="center">
                            <tr>
                                        ...
                                        <tr>
                                            <td style="text-align: center; padding: 0 0 0;">
                                                <div
                                                    ...
                                                    Арбитр принял решение, претензия №{{$report->id}} {{$status}}.
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
            ...
            <table id="rec549848307" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="618">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin549848307" class="r"
                               style="margin: 0 auto;background-color:#ffffff;border-spacing: 0;width:600px;"
                               align="center">
                            <tr>
