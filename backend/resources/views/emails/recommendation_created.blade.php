...
<head>
    ...
    <title>У вас новая рекомендация</title>
...
<table id="allrecords" class="t-records" data-tilda-email="yes" data-tilda-project-id="6660033"
       data-tilda-page-id="34026946" data-tilda-page-alias="" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td style="background-color: #efefef; "><!--record_mail-->
            ...
            <table id="rec549842032" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="323">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin549842032" class="r"
            ...
            <table id="rec549842033" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="329">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin549842033" class="r"
                               style="margin: 0 auto;background-color:#ffffff;border-spacing: 0;width:600px;"
                               align="center">
                            <tr>
            ...
            <table id="rec549842034" style="width:100%; border-collapse:collapse; border-spacing:0; margin:0; border:0;"
                   cellpadding="0" cellspacing="0" data-record-type="618">
                <tr>
                    <td style="padding-left:15px; padding-right:15px; ">
                        <table id="recin549842034" class="r"
                               style="margin: 0 auto;background-color:#ffffff;border-spacing: 0;width:600px;"
                               align="center">
                            <tr>
                                                    ...
                                                    <tr>
                                                        <td> <!--[if mso]>
                                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                ...
                                                                href="{{url('profile/recommendations')}}"> Перейти на сайт </a> <!--[endif]--> </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
